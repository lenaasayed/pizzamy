...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewResult = findViewById(R.id.text1);
/////////////////////////////////////////////////////
        ...
        // Call<CategoryModel> call = jsonPlaceHolderApi.getCategory();
        Call<CategoryModel> call = apiService.getCategory();
        call.enqueue(new Callback<CategoryModel>() {
            ...
            public void onResponse(Call<CategoryModel> call, Response<CategoryModel> response) {
                ...
                if (response.body() == null)
                    ...
                    recyclerAdapter = new Adapter(MainActivity.this, movieList.getAlbums().getItems());
